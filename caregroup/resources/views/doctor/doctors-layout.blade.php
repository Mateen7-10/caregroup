        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            <li class="sidebar-item">
                <a class="sidebar-link" href="{{route('doctor_dashbord')}}" aria-expanded="false">
                  <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{route('patients_info')}}" aria-expanded="false">
                <span>
                  <i class="fa-solid fa-hospital-user"></i>
                </span>
                <span class="hide-menu">Patients Info</span>
              </a>
            </li>            
          </ul>
        </nav>
      ...
      <div class="branding d-flex align-items-center">
        ...
        >
          <a href="{{route('index')}}" class="logo d-flex align-items-center me-auto">
             <img src="assets/img/brand_icon.png" alt="caregroup" style="width: 30px; ">
          </a>
